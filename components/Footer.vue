...
<<<<<<< HEAD
        <svg width="100" height="38" viewBox="0 0 108 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0)">
            ...
            <path d="M63.6 23H75.696V22.552C72.848 22.488 71.984 21.944 71.984 20.728V1.272H72.752C75.216 1.272 77.136 3.736 79.376 8.088L79.856 8.024L79.696 0.695999H59.568L59.376 8.024L59.856 8.088C62.128 3.64 64.08 1.272 66.512 1.272H67.312V20.728C67.312 21.944 66.416 22.488 63.6 22.552V23Z" fill="white"/>
...
=======
        <div class="logo flex-grow-1 flex-fill">
        ...
        <p class="text-white pt-4">Get out there & discover your next slope, mountain & destination!</p>
        <p class="mt-5 pt-5 copyright text-white">Copyright 2019 MNTN, Inc. Terms & Privacy</p>
>>>>>>> 8f9c59ec05f81ec10f06cab1b98d8858e8407cb6
      </div>
