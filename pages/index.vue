      ...
      <div class="text">
        <div class="guide">
          <div class="title">
            ...
            <p id="hiking">A Hiking guide</p>
          </div>
          <p id="text">Be prepared for the Mountains and beyond!</p>
          <div class="arrow">
            <p>scroll down</p>
